  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-16 pb-20 px-4">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-border pb-10">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground">System Path: /root/intelligence/reports</span>
          </div>
        ...
        <div className="flex items-center gap-4">
           <Button className="rounded-2xl premium-gradient px-8 font-black uppercase tracking-widest text-[10px] h-14 shadow-2xl shadow-primary/30 border-t border-foreground/20 active:scale-95 transition-all">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
         <Card className="lg:col-span-2 glass-card border-none rounded-3xl p-10 bg-foreground/[0.01]">
            ...
            <CardContent className="p-0 space-y-10">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4 p-6 glass-card border-none rounded-2xl bg-foreground/[0.02] hover:bg-foreground/[0.05] transition-colors cursor-pointer group">
               ...
               <div className="pt-8 border-t border-border">
                  <Button className="w-full h-16 rounded-3xl premium-gradient text-white hover:scale-[1.02] active:scale-95 transition-all font-black uppercase tracking-widest text-xs group">
         ...
         <div className="space-y-8">
            <Card className="glass-card border-none rounded-3xl p-8 bg-foreground/[0.01]">
               ...
               <CardContent className="p-0 space-y-4">
                  {recentReports.map((report, i) => (
                    <div key={i} className="p-4 rounded-2xl bg-foreground/5 border border-border flex items-center justify-between group hover:border-primary/20 transition-colors">
            ...
            <Card className="glass-card border-none rounded-3xl p-8 bg-[#7c3aed] text-white relative overflow-hidden group">
               <div className="absolute top-0 right-0 w-32 h-32 bg-foreground/20 rounded-full blur-[40px] -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-1000" />
               <div className="relative z-10 flex flex-col h-full space-y-6">
                  <div className="p-2 bg-foreground/20 rounded-lg w-fit">
                     <Share2 className="h-4 w-4" />
                  </div>
                  <div className="space-y-2">
                     <h4 className="text-lg font-black font-outfit uppercase italic">Share Intelligence</h4>
                     <p className="text-xs text-foreground/70 leading-relaxed font-medium">Securely distribute findings to peer security organizations via neural-tunnel.</p>
                  </div>
      ...
      <div className="flex items-center justify-center gap-12 pt-12 opacity-30">
         ...
         <span className="text-[10px] font-black uppercase tracking-[0.5em] whitespace-nowrap text-foreground">End of Audit Stream</span>
